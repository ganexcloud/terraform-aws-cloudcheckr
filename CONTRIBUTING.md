...
The Terraform Registry is connected to this repository once by the module owner.
After initial registration, Registry versions are indexed from Semantic Release
Git tags.
