...
resource "aws_iam_role_policy_attachment" "custom" {
  ...
  policy_arn = aws_iam_policy.CloudWatchFlowLogsPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom1" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.CloudTrailPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom2" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.SecurityPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom3" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.InventoryPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom4" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.DbrPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom5" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.CurPolicy.arn
}

resource "aws_iam_role_policy_attachment" "custom6" {
  role       = aws_iam_role.this.name
  policy_arn = aws_iam_policy.CostPolicy.arn
}
